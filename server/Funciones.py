def nuevo_usuario(usuario, correo, ciudad, contrasena, confirme):
...
def modificar_contrasena(contrasena, nueva_contrasena):
...
def modificar_correo(correo, nueva_correo):
...
def modificar_ciudad(ciudad, nueva_ciudad):
